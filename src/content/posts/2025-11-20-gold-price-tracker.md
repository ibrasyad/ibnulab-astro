...
description: A project which mainly to help gain insight in gold prices for
  ...
  not the exact price, but should be enough as an overall picture.
...
Well, so here we are, a dataset that will continuously track the price of gold daily. This is not perfect, nor this is accurate. Why? Because usually it'll be different when you actually go visit and buy, it is especially specific for Galeri 24 and might be different for other store. The simplest I could do for now is to scrap the [Galeri 24 website](https://galeri24.co.id/harga-emas) and get the price from there. I'm not quite sure when they change the price on their website, but I just take a guess and choose 12 PM.
...
Oh by the way, if you have any suggestion or want to discuss, feel free to contact me. Hit me up if you make something cool from this dataset.

# Thanks to

Thanks to Galeri 24 for making their pricing data publicly available. Based on their robots.txt, this scraping activity is permitted. However, if this project causes any issues or violates any policy, please contact me.
