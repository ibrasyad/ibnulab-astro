...
export const siteConfig: SiteConfig = {
	title: "Ibnulab",
	subtitle: "Prologue",
	siteURL: "https://ibnulab.com/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2024-11-01", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	navbarTitle: {
		...
		// 网站Logo图片路径
		logo: "assets/home/ibnulab logo.webp",
	},
...
export const commentConfig: CommentConfig = {
	...
	giscus: {
		repo: "ibrasyad/ibnulab-astro",
		repoId: "R_kgDOP6Onrg",
		category: "General",
		categoryId: "DIC_kwDOP6Onrs4DAzgL",
		mapping: "pathname",
		strict: "1",
		reactionsEnabled: "1",
		emitMetadata: "0",
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "Welcome to my blog! I share things I've learnt and done in life.", // 公告内容
